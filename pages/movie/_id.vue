...
export default {
  ...
  // nuxt에서 제공하는 ssr 전에 데이터 셋팅
  // asyncData에선 this 사용 못함
  // 대신 context라는 객체를 제공하는데
  // 이를 구조분해 하면 { store, route, params }
  // 외부에 있는 서버에서 데이터를 가져온다면
  // ssr 되지 전에 셋팅을 해야 해서 비동기 처리를 해야한다.
  // 그리고 가져오는 데이터는 반드시 asyncData로 비동기처리
